...
export const shippingAddressSchema = z.object({
  ...
  streetAddress: z.string().min(3, "Address must be at least 3 character"),
  city: z.string().min(3, "City must be at least 3 character"),
  postalCode: z.string().min(3, "Postal Code must be at least 3 character"),
  country: z.string().min(3, "Country must be at least 3 character"),
...
// Schema for iserting order item
